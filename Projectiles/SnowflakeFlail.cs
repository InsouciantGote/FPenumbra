...
{
	public class SnowflakeFlail : ModProjectile
	{
		// The folder path to the flail chain sprite
		private const string ChainTexturePath = "FPenumbra/Projectiles/SnowflakeChain";

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Snowflake Ball");
		}
		...
		public override void AI()
		{
			...
			if (projectile.ai[0] == 0f) {
				if (Main.rand.NextBool(2))
				{
					...
					Projectile.NewProjectile(projectile.Center, vel, mod.ProjectileType("SnowflakeShard"), projectile.damage / 2, projectile.knockBack / 2, projectile.owner);
				}
