...
{
    public class FrostjawTail : ModNPC
    {
        public int Timer;
        ...
        public override void HitEffect(int hitDirection, double damage)
        {
            ...
            if (npc.life <= 0 && player.active)
            {
                ...
                Gore.NewGore(npc.position, npc.velocity, mod.GetGoreSlot("Gores/FrostjawTailGore1"), npc.scale);
                Gore.NewGore(npc.position, npc.velocity, mod.GetGoreSlot("Gores/FrostjawTailGore2"), npc.scale);
            }
        }
